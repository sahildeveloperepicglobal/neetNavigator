  ...
  return (
    <>
      ...
      <section className="container2">
        <section className={styles.privacypolicysec}>
          <h1>Privacy Policy</h1>
          <p>
            NeetNavigator.com (“us”, “we”, or “our”) operates the
            https://neetnavigator.com/ website (the “Service”).
          </p>
          <p>
          ...
          <p>
            We collect several type of information for various purposes to
          ...
          <ul>
            ...
            <li>Phone number</li>
            <li>Educational qualifications and other academic details</li>
          ...
          <ul>
            <li>
              By email:{" "}
              <a href="emailto:lighthouse@neetnavigator.com">
                lighthouse@neetnavigator.com
              </a>
              <br></br>
              <span>
                <a href="emailto:info@neetnavigator.com">
                  info@neetnavigator.com
                </a>
              </span>
            </li>
            <li>
              By phone number: <a href="tel:+91 99103 75900">+91 99103 75900</a>
            </li>
          </ul>
        </section>
      </section>
